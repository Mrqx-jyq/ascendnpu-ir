...
// MixC2 fusion: mesh communication + matmul patterns only.
// Kept conservative to avoid creating oversized multi-cube kernels
// that exceed L1/L0C capacity and cause register spilling.

...
module {
  // CHECK: func.func @testA_multi_LAST_AXIS_PBR_0_tiling_function
  // CHECK: hacc.host_func_type = #hacc.host_func_type<tiling_function>

  // CHECK: func.func @testA_multi_LAST_AXIS_PBR_0_0
  // CHECK: hfusion.fusion_kind = #hfusion.fusion_kind<LAST_AXIS_PBR>

  // CHECK: func.func @testA
  // CHECK: hfusion.fusion_kind = #hfusion.fusion_kind<SHALLOW_VV>
  // CHECK: call @testA_multi_LAST_AXIS_PBR_0_0

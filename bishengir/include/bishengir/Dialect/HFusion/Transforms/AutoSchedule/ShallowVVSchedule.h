...
//
//===----------------------------------------------------------------------===//
#ifndef BISHENGIR_DIALECT_HFUSION_TRANSFORMS_AUTOSCHEDULE_SHALLOWVVSCHEDULE_H
#define BISHENGIR_DIALECT_HFUSION_TRANSFORMS_AUTOSCHEDULE_SHALLOWVVSCHEDULE_H
...
public:
  explicit ShallowVVScheduler(func::FuncOp funcOpIn)
      : SchedulerBase(funcOpIn, FusionKind::ShallowVV){};
...
#endif // BISHENGIR_DIALECT_HFUSION_TRANSFORMS_AUTOSCHEDULE_SHALLOWVVSCHEDULE_H
